...
# 指定Parquet文件路径
GRAPHRAG_FOLDER = "/home/zxd/code/Chat/GraphragDemo/demo/dentistry/output/artifacts"

# 数据库连接相关参数配置
NEO4J_URI = "bolt://192.168.0.246:7687"
NEO4J_USERNAME = "neo4j"
NEO4J_PASSWORD = "12345678"
NEO4J_DATABASE = "dentistry"
...
community_report_df = pd.read_parquet(f'{GRAPHRAG_FOLDER}/create_final_community_reports.parquet',
                                      columns=["id", "community", "findings", "title", "summary", "level", "rank",
